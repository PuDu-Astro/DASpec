...
class GUI(Tkinter.Frame):
    ...
    def addmodel(self):
        ...
        for iwin in [len(self.models) - 1]:
            ...
            m = Tkinter.Menubutton(self.windows[1], text = self.models[iwin][0], width = 12)
    ...
    def set_model(self):
        ...
        Tkinter.Button(self.windows[1], text = "Use result", command = self.model_useresult).grid(row = 0, column = 4, sticky = Tkinter.W)

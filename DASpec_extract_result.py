...
class DASpec_result:
    ...
    def __init__(self, filename):
        ...
        for i in range(self.num):
            ...
            self.limitarrays.append(limits_ii)
        ...
        for i in range(len(self.models)):
            ...
            if len(self.ties[i]) != 0:
                for j in range(len(self.ties[i])):
                    if self.ties[i][j][0] == "flux_profile":
                            self.DAmodels[i].addtie_flux_profile(self.ties[i][j][1], self.ties[i][j][2], self.ties[i][j][3])
                    elif self.ties[i][j][0] == "profile":
                        self.DAmodels[i].addtie_profile(self.ties[i][j][1], self.ties[i][j][2])
                    elif self.ties[i][j][0] == "tie":
                        self.DAmodels[i].addtie(self.ties[i][j][1], self.ties[i][j][2], \
                            self.ties[i][j][3], self.ties[i][j][4], self.ties[i][j][5], self.ties[i][j][6])

            if len(self.fixes[i]) != 0:
                for j in range(len(self.fixes[i])):
                    self.DAmodels[i].addfix(self.fixes[i][j][0], self.fixes[i][j][1], self.fixes[i][j][2])
        ...
        self.limitarrays = np.array(self.limitarrays)
